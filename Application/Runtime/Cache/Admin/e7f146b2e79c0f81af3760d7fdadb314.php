...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list">
            <i class="icon-font"></i><a href="#">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">分区管理</a><span class="crumb-step">&gt;</span><span>新增分区</span>
        </div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/index.php/admin/cate/save" method="post" id="myform" name="myform">
                <table class="insert-tab" width="100%">
                <tbody>
                <tr>
                    <th width="120">
                        <i class="require-red">*</i>所属分区：
                    </th>
                    <td>
                ...
                <tr>
                    <th width="120">
                        <i class="require-red">*</i>版主名称：
                    </th>
                    <td>
                        <select name="uid" id="catid" class="required">
                            <?php foreach($users as $user): ?>
                            <option value="<?=$user['uid']?>"><?=$user['uname']?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </td>
