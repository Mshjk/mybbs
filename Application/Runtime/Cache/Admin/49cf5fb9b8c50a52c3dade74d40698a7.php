...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list">
            <i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span>
        </div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/index.php/admin/user/save" method="post" id="myform" name="myform" enctype="multipart/form-data">
                <table class="insert-tab" width="100%">
                <tbody>
                <tr>
                    <th width="120">
                        <i class="require-red">*</i>权限：
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="common-text" name="upwd" size="50" value="" type="password">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input class="common-text" name="reupwd" size="50" value="" type="password">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input class="common-text" name="age" size="50" value="" type="text">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="radio" name="sex" value="m">男 <input type="radio" name="sex" value="w" checked>女 <input type="radio" name="sex" value="x">保密
                    </td>
                </tr>
                <tr>
                    <th>
