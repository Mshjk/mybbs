...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list">
            <i class="icon-font"></i><a href="/index.php/admin">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/admin/part/index">分区管理</a><span class="crumb-step">&gt;</span><span>新增分区</span>
        </div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/index.php/admin/part/save" method="post" id="myform" name="myform" enctype="multipart/form-data">
