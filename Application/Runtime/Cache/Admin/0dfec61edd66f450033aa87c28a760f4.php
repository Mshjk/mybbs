...
<div class="admin_login_wrap">
        ...
        <div class="admin_input">
            <form action="/index.php/admin/login/dologin" method="post">
                <ul class="admin_items">
                    ...
                    <img style="vertical-align: top"onclick="this.src='/index.php/admin/login/getCode/s='+Math.random()" src="/index.php/admin/login/getCode"/>
                    </li>
                    <li>
    ...
    <p class="admin_copyright">
        <a tabindex="5" href="/index.php/admin/index" target="_self">返回首页</a> &copy; 2019 Powered by <a href="http://www.mycodes.net/" target="_blank">Mybbs</a>
    </p>
</div>
</body>
</html>