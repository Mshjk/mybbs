...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list">
            <i class="icon-font"></i><a href="/index.php/admin">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/admin/cate/index">版块管理</a><span class="crumb-step">&gt;</span><span>修改版块</span>
        </div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/index.php/admin/cate/update" method="post" id="myform" name="myform" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <select name="pid" id="catid" class="required">
                            ...
                            <option value="<?=$part['pid']?>" <?php if($cate['pid'] == $part['pid']) { echo 'selected'; } ?>
                            ><?=$part['pname']?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <tr>
                    <th width="120">
                        <i class="require-red">*</i>指定版主：
                    </th>
                    <td>
                        <select name="uid" id="catid" class="required">
                            <?php foreach($users as $user): ?>
                            <option value="<?=$user['uid']?>" <?php if($cate['uid'] == $user['uid']) { echo 'selected'; } ?>
                            ><?=$user['uname']?>
                            </option>
                            <?php endforeach; ?>
                        </select>
